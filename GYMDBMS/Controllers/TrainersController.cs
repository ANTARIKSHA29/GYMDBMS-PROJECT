...
namespace GYMDBMS.Controllers
{
    public class TrainersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TrainerId,Name,ContactNumber,Specialty")] Trainer trainer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("TrainerId,Name,ContactNumber,Specialty")] Trainer trainer)
        {
