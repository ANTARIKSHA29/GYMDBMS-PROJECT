...
namespace GYMDBMS.Controllers
{
    public class WorkoutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WorkoutId,Name,Description")] Workout workout)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("WorkoutId,Name,Description")] Workout workout)
        {
